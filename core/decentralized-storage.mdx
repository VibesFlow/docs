...
description: "Backend storage infrastructure with DynamoDB persistence and Filecoin integration"
---

# Decentralized Storage

VibesFlow implements a hybrid storage architecture combining DynamoDB for metadata persistence, Filecoin for permanent audio storage, and intelligent caching systems for optimal performance.
