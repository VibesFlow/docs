...
description: "SRS streaming system for real-time audio distribution to participants"
---

# Streaming Infrastructure

VibesFlow uses Simple Realtime Server (SRS) for distributing live audio streams from creators to participants in real-time. The streaming infrastructure enables group vibestreams with low-latency audio delivery.
