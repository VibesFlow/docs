...
description: "Decentralized content delivery network for vibestream playback and market access"
---

# FilCDN Integration

FilCDN provides decentralized content delivery for VibesFlow vibestreams, enabling direct access to Filecoin-stored content with fallback mechanisms for optimal performance.
