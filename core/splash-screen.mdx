---
title: "Splash Screen"
description: "The Splash Screen is VibesFlow's main entry point, providing wallet connection, live vibestream tracking, and navigation to core features. It implements the primary user interface for accessing the platform's functionality."
---
...
It manages multi-network wallet connections and Real-time tracking of active vibestreams across networks.
