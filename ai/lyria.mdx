...
description: 'Google Lyria RealTime API integration for streaming music generation'
---

# Lyria RealTime Integration

The Lyria RealTime integration provides direct access to Google's state-of-the-art streaming music generation model, enabling interactive music creation with continuous steering and real-time parameter adjustments.
...
## Musical Scale Support

### Available Scales

Lyria supports comprehensive musical scale control:

| Scale Value | Musical Scale |
|-------------|---------------|
...
| `SCALE_UNSPECIFIED` | Model decides automatically |
...
await session.setMusicGenerationConfig({
  musicGenerationConfig: {
    scale: 'G_MAJOR_E_MINOR',  // All white keys except F#
    bpm: 140,
    density: 0.6
  }
});

// Context reset required for scale changes
await session.reset_context();
```
...
Lyria supports extensive instrument vocabulary:

```javascript
// Electronic instruments
"303 Acid Bass", "808 Hip Hop Beat", "TR-909 Drum Machine", 
"Moog Oscillations", "Dirty Synths", "Spacey Synths"

// Acoustic instruments  
"Acoustic Guitar", "Precision Bass", "Rhodes Piano", 
"Ragtime Piano", "Smooth Pianos"

// World instruments
"Sitar", "Tabla", "Koto", "Didgeridoo", "Steel Drum"
```
...
```javascript
// Electronic genres
"Minimal Techno", "Deep House", "Acid Jazz", "Drum & Bass", 
"Dubstep", "Psytrance", "Breakbeat"

// Traditional genres
"Blues Rock", "Jazz Fusion", "Reggae", "Salsa", 
"Celtic Folk", "Indian Classical"
```
...
"Ambient", "Dreamy", "Ethereal Ambience", "Psychedelic", 
"Ominous Drone", "Bright Tones"

// Technical qualities
"Crunchy Distortion", "Fat Beats", "Glitchy Effects", 
"Swirling Phasers", "Echo", "Saturated Tones"
```
